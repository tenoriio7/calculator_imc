  ...
  void _calculate() {
    setState(() {
      ...
      if (imc < 18.6) {
        ...
        _inforText = "Obesidade Grau I ${imc.toStringAsPrecision(3)}";
      } else if (imc < 34.9) {
        _inforText = "Obesidade Grau II  ${imc.toStringAsPrecision(3)}";
      } else if (imc < 40) {
        _inforText = "Obesidade Grau III ${imc.toStringAsPrecision(3)}";
      }
    });
  }
